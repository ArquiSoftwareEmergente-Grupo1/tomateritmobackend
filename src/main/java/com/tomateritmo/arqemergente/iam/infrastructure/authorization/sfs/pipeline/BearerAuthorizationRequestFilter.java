package com.tomateritmo.arqemergente.iam.infrastructure.authorization.sfs.pipeline;
...
import com.tomateritmo.arqemergente.iam.infrastructure.authorization.sfs.model.UsernamePasswordAuthenticationTokenBuilder;
import com.tomateritmo.arqemergente.iam.infrastructure.tokens.jwt.BearerTokenService;
...
public class BearerAuthorizationRequestFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(@NonNull HttpServletRequest request,
    ...
    try {
      ...
      // Si no hay token, no modificar el contexto ni loggear como error
    } catch (Exception e) {
